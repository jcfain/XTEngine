...
# DEFINES += XTENGINE_VERSION=0.61f
# DEFINES += XTENGINE_VERSION_NAME=0.61b
DEFINES += VERSION_MAJOR=0
DEFINES += VERSION_MINOR=6
DEFINES += VERSION_REVISION=1
DEFINES += VERSION_PHASE=b
# DEFINES += _STRINGIFY(x) #x
# DEFINES += STRINGIFY(x) _STRINGIFY(x)

# #// /* here's the magic */
# DEFINES += _CONCAT(x,y) x##y
# DEFINES += CONCAT(x,y) _CONCAT(x,y)
# DEFINES += XTENGINE_VERSION VERSION_MAJOR + VERSION_MINOR
# DEFINES += XTENGINE_VERSION_NAME STRINGIFY(VERSION_MAJOR.CONCAT(VERSION_MINOR,REVISION))
